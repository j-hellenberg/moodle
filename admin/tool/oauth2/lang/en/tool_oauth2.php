...
$string['performrolemapping'] = 'Perform role mapping for users from IDP to Moodle';
$string['pluginname'] = 'OAuth 2 services';
$string['rolemappingmappedattribute'] = 'User-attribute to be used for role mapping. Must be contained in userinfo.';
$string['rolemappingrolenameprefix'] = 'Prefix that should be stripped off the role names received from the IdP before performing role mapping.';
